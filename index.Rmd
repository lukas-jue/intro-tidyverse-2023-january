...
| 2    | 12.01. | Data and visualization             | Lecture              | Lara     |
| 2    | 12.01. | Visualizing data with ggplot2      | Lecture              | Lara     |
| 2    | 19.01. | Visualizing categorical data       | Lecture              | Lara     |
| 2    | 19.01. | StarWars + Dataviz                 | Application Exercise |          |
| 3    | 19.01. | Tidy data                          | Lecture              | Karlo    |
| 3    | 19.01. | Grammar of data wrangling          | Lecture              | Karlo    |
| 3    | 19.01. | Working with a single data frame   | Lecture              | Lara     |
| 3    | 19.01. | Hotels + Data wrangling            | Application Exercise |          |
| 3    | 26.01. | Working with multiple data frames  | Lecture              | Karlo    |
| 4    | 26.01. | Data types                         | Lecture              | Karlo    |
| 4    | 26.01. | Importing data                     | Lecture              | Lara     |
| 4    | 26.01. | Nobels + Sales + Data import       | Application Exercise |          |
| 5    | 26.01. | Fitting and interpreting models    | Lecture              | Lara     |
