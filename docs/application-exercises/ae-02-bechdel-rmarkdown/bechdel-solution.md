...
Your task is to fill in the blanks denoted by `___`. Don’t worry, if you
do not understand most parts of the code — you’ll get there soon.
...
![](bechdel-solution_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](bechdel-solution_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
