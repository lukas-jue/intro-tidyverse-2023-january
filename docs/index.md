...
offered for GRADE Brain at Goethe University in the summer term of 2021.
...
-   Please create an RStudio Cloud account before the first class. We have sent you a link to access all exercises on RStudio Cloud. Since we want you to start coding very early on in the first class, please ensure that you can access those course materials on RStudio Cloud before meeting on 22 April.
...
|------|----------|------------------------------------|----------------------|--------------|
| 1    | 22 April | Welcome                            | Lecture              | Lukas        |
| 1    | 22 April | First data visualization: UN Votes | Application Exercise |              |
| 1    | 22 April | Meet the programming toolkit       | Lecture              | Karlo        |
| 1    | 22 April | The Bechdel Test + R Markdown      | Application Exercise |              |
| 2    | 22 April | Data and visualization             | Lecture              | Lara         |
| 2    | 22 April | Visualizing data with ggplot2      | Lecture              | Lara         |
| 2    | 29 April | Visualizing categorical data       | Lecture              | Lara         |
| 2    | 29 April | StarWars + Dataviz                 | Application Exercise |              |
| 3    | 29 April | Tidy data                          | Lecture              | Karlo        |
| 3    | 29 April | Grammar of data wrangling          | Lecture              | Karlo        |
| 3    | 29 April | Working with a single data frame   | Lecture              | Lukas        |
| 3    | 6 May    | Working with multiple data frames  | Lecture              | Lukas        |
| 3    | 6 May    | Hotels + Data wrangling            | Application Exercise |              |
| 4    | 6 May    | Data types                         | Lecture              | Karlo        |
| 4    | 6 May    | Importing data                     | Lecture              | Lara & Karlo |
| 4    | 6 May    | Nobels + Sales + Data import       | Application Exercise |              |
| 5    | 6 May    | Fitting and interpreting models    | Lecture              | Lukas        |
